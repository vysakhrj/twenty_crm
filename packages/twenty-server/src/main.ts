...
const bootstrap = async () => {
  ...
  // Gzip/deflate responses (large GraphQL metadata/records payloads and the
  // static frontend bundle). Skip Server-Sent Events so subscription streams
  // are not buffered by the compressor.
  app.use(
    compression({
      filter: (req, res) => {
