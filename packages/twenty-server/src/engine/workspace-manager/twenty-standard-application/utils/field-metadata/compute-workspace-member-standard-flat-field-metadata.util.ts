...
> => ({
  ...
  availabilityStartTime: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Daily availability start time (HH:mm)',
      icon: 'IconClockHour4',
      isNullable: false,
      defaultValue: "'00:00'",
    },
  ...
  availabilityEndTime: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Daily availability end time (HH:mm)',
      icon: 'IconClockHour8',
      isNullable: false,
      defaultValue: "'24:00'",
    },
  ...
  availabilityHours: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'End of availability as hour of day (1-24)',
      icon: 'IconClock',
      isNullable: true,
      settings: {
        dataType: NumberDataType.INT,
  ...
  availableDays: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Days of week when the user can be assigned',
      ...
      options: [
        ...
        { value: 'SATURDAY', label: 'Saturday', position: 5, color: 'purple' },
        { value: 'SUNDAY', label: 'Sunday', position: 6, color: 'sky' },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  leaveStartDate: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Date and time when leave starts',
      icon: 'IconCalendarMinus',
      isNullable: true,
      settings: { displayFormat: DateDisplayFormat.RELATIVE },
    },
  ...
  leaveEndDate: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Date and time when leave ends',
